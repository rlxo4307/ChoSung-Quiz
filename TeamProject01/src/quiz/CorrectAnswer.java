...
public class CorrectAnswer extends JFrame {
	...
	public CorrectAnswer(VO2 vo2){
		setResizable(false);
		System.out.println("¢∆¢∆¢∆¢∆¢∆ CorrectAnswer ¿Ãµø øœ∑· ¢∆¢∆¢∆¢∆¢∆");
		vo3 = vo2;
		...
		lbl_passmark.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 26));
		...
		lbl_passmark.setText("  "+vo3.getDap());
	      ...
	      lblQuiz.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 30));
		...
		btnGiveUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==btnGiveUp) {
					String stop="∞‘¿”¿ª ∆˜±‚«œ∞⁄Ω¿¥œ±Ó?";
					int result=JOptionPane.showConfirmDialog
					(btnGiveUp, stop, "∞‘¿”¿Ã ≥°≥µΩ¿¥œ¥Ÿ", JOptionPane.YES_NO_OPTION);
		...
		btnGiveUp.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 15));
			...
			public void actionPerformed(ActionEvent e) {
				...
				setVisible(false);
					if(vo3.getSido()>0) { // Ω√µµ»Ωºˆ∞° ¿÷¥Ÿ∏È
						...
						dispose();
						setVisible(false);
						String stop="∞‘¿”¡æ∑·:YES / ¿Áµµ¿¸:NO";
						int result=JOptionPane.showConfirmDialog
						(null, stop, "∞‘¿”¿Ã ≥°≥µΩ¿¥œ¥Ÿ", JOptionPane.YES_NO_OPTION);
		...
		btnNext.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 15));
		...
		lbl_user.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 12));
		...
		lbl_maxscore.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 12));
		...
		lbl_vcount.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 12));
		...
		lbl_ui_id_1.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 12));
		lbl_ui_id_1.setBounds(150, 500, 80, 15);
		cp_left_m.add(lbl_ui_id_1);
		
		JLabel lbl_logout = new JLabel("");
		lbl_logout.setOpaque(true);
		lbl_logout.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 14));
		...
		lblNewLabel_3.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 12));
		...
		lblNewLabel_1.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.PLAIN, 11));
