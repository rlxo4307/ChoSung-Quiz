...
public class Start extends JFrame {
	...
	public Start(){
		setResizable(false);
		System.out.println("�ƢƢƢƢ� Start �̵� �Ϸ� �ƢƢƢƢ�");
		...
		btn_Enter.setFont(new Font("���� ���", Font.PLAIN, 14));
		...
		btn_SignUp.setFont(new Font("���� ���", Font.PLAIN, 14));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource()==btn_Enter) {		
					...
					if(b1) {
						dispose();
						setVisible(false);
						new Topic(vo2 = td.TOtopicNrank(id)).setVisible(true); // Toss_DAO -> VO2 ��ȯ
					}
					else {
